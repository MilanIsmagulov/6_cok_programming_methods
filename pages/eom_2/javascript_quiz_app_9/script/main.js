...
let mainQuestions = [
    {
        text: 'Укажите, что представляют собой классы в объектно-ориентированном программировании.',
        right: [0],
        type: 1,
        points: 100,
        answers: ['Структуры и функционирование объектов с общими характеристиками и поведением','Модули, разделенные на строительные блоки программы','Скрытые проектные решения в модулях программы','Интерфейсы и конкретные реализации абстрактных типов данных'],
    },
];
