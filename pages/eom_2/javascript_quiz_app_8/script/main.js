...
let mainQuestions = [
    {
        text: 'Определите, что такое объектно-ориентированное программирование.',
        right: [1],
        type: 1,
        points: 100,
        answers: ['Метод программирования, основанный на модели фон Неймана и последовательном изменении состояния компьютера','Метод программирования, основанный на модели объектов и классов, с обменом сообщениями между объектами','Метод программирования, основанный на модели функций и их вызовов','Метод программирования, основанный на модели данных и запросов к ним'],
    },
];
