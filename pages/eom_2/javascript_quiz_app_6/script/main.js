...
let mainQuestions = [
    {
        text: 'Укажите, какая цель стоит перед структурным программированием.',
        right: [3],
        type: 1,
        points: 100,
        answers: ['Создание программ, основанных на объектах и классах, с обменом сообщениями между ними','Создание программ, основанных на модулях, с независимой работой каждого модуля','Создание программ, основанных на абстрактных типах данных и инкапсуляции','Создание надежных программ, легко поддерживаемых и модифицируемых, а также ускорение процесса разработки'],
    },
];
