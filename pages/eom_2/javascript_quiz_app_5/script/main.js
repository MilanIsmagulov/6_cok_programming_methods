...
let mainQuestions = [
    {
        text: 'Укажите, что такое императивное программирование.',
        right: [0],
        type: 1,
        points: 100,
        answers: ['Метод программирования, основанный на модели фон Неймана, применяемый на языках Basic, Pascal, C', 'Метод программирования, основанный на модели объектов и классов, применяемый на языках Java, C++, Python', 'Метод программирования, основанный на модели функций, применяемый на языках JavaScript, Ruby, Swift', 'Метод программирования, основанный на модели данных и запросов, применяемый на языках SQL, NoSQL.',],
    },
];
